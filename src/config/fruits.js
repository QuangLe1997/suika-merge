...
export const FRUITS = [
  ...
  { level: 2,  name: 'Strawberry', emoji: '🍓', radius: 23, score: 3,  color: '#f08080', glow: '#ff9aa2', sprite: SPRITE_BASE + '02-strawberry.png' },
  ...
  { level: 5,  name: 'Lemon',      emoji: '🍋', radius: 42, score: 15, color: '#ffb700', glow: '#ffdd66', sprite: SPRITE_BASE + '05-lemon.png' },
  { level: 6,  name: 'Apple',      emoji: '🍎', radius: 49, score: 24, color: '#d62828', glow: '#ff5959', sprite: SPRITE_BASE + '06-apple.png' },
  { level: 7,  name: 'Pear',       emoji: '🍐', radius: 57, score: 36, color: '#c5e063', glow: '#dfff89', sprite: SPRITE_BASE + '07-pear.png' },
  { level: 8,  name: 'Peach',      emoji: '🍑', radius: 65, score: 52, color: '#ffb6a3', glow: '#ffd1c1', sprite: SPRITE_BASE + '08-peach.png' },
  { level: 9,  name: 'Pineapple',  emoji: '🍍', radius: 72, score: 72, color: '#f9c74f', glow: '#ffe082', sprite: SPRITE_BASE + '09-pineapple.png' },
  { level: 10, name: 'Melon',      emoji: '🍈', radius: 79, score: 96, color: '#6a994e', glow: '#a7c957', sprite: SPRITE_BASE + '10-melon.png' },
  { level: 11, name: 'Watermelon', emoji: '🍉', radius: 86, score: 130, color: '#2d6a4f', glow: '#74c69d', sprite: SPRITE_BASE + '11-watermelon.png' },
];
